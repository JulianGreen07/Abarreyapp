...
public class UserDAO {
    public List<User> findAll() throws SQLException {
        ...
        System.out.println("UserDAO.findAll: SQL=" + sql);
    ...
    public int insert(User u) throws SQLException {
        ...
        System.out.println("UserDAO.insert: SQL=" + sql + " name=" + u.getName());
    ...
    public boolean update(User u) throws SQLException {
        ...
        System.out.println("UserDAO.update: SQL=" + sql + " id=" + u.getId());
        try (Connection c = DB.getConnection(); PreparedStatement ps = c.prepareStatement(sql)) {
            ps.setString(1, u.getName());
            ps.setString(2, u.getRole());
            ps.setString(3, u.getEmail());
    ...
    public boolean delete(int id) throws SQLException {
        ...
        System.out.println("UserDAO.delete: SQL=" + sql + " id=" + id);
        try (Connection c = DB.getConnection(); PreparedStatement ps = c.prepareStatement(sql)) {
            ps.setInt(1, id);
            ps.setInt(2, com.abarreyapp.db.BranchContext.getCurrentBranchId());
            return ps.executeUpdate() > 0;
